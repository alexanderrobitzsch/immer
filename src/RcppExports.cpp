...
Rcpp::List immer_jml_update_item_derivatives(Rcpp::NumericVector theta, Rcpp::NumericMatrix score_items, int N, int K, int I, Rcpp::IntegerMatrix dat_resp, Rcpp::NumericMatrix b, Rcpp::NumericVector A_, Rcpp::NumericVector xsi, double max_incr, Rcpp::NumericMatrix b_fixed);
RcppExport SEXP _immer_immer_jml_update_item_derivatives(SEXP thetaSEXP, SEXP score_itemsSEXP, SEXP NSEXP, SEXP KSEXP, SEXP ISEXP, SEXP dat_respSEXP, SEXP bSEXP, SEXP A_SEXP, SEXP xsiSEXP, SEXP max_incrSEXP, SEXP b_fixedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type theta(thetaSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(immer_jml_update_item_derivatives(theta, score_items, N, K, I, dat_resp, b, A_, xsi, max_incr, b_fixed));
    return rcpp_result_gen;
END_RCPP
}
// immer_jml_update_theta_derivatives
Rcpp::List immer_jml_update_theta_derivatives(Rcpp::NumericVector theta, Rcpp::NumericVector score_pers, int N, int K, int I, Rcpp::NumericMatrix b, double max_incr, Rcpp::IntegerMatrix dat_resp);
RcppExport SEXP _immer_immer_jml_update_theta_derivatives(SEXP thetaSEXP, SEXP score_persSEXP, SEXP NSEXP, SEXP KSEXP, SEXP ISEXP, SEXP bSEXP, SEXP max_incrSEXP, SEXP dat_respSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type theta(thetaSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type max_incr(max_incrSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type dat_resp(dat_respSEXP);
    rcpp_result_gen = Rcpp::wrap(immer_jml_update_theta_derivatives(theta, score_pers, N, K, I, b, max_incr, dat_resp));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_immer_immer_jml_update_item_derivatives", (DL_FUNC) &_immer_immer_jml_update_item_derivatives, 11},
    {"_immer_immer_jml_update_theta_derivatives", (DL_FUNC) &_immer_immer_jml_update_theta_derivatives, 8},
    {NULL, NULL, 0}
};
