...
Rcpp::NumericVector immer_cml_agrad_helper(Rcpp::NumericMatrix esf_par0, Rcpp::List parm_index, Rcpp::List splitvec_len, Rcpp::List suffstat, Rcpp::List score_freq, bool diff, int NP, Rcpp::NumericMatrix W);
RcppExport SEXP _immer_immer_cml_agrad_helper(SEXP esf_par0SEXP, SEXP parm_indexSEXP, SEXP splitvec_lenSEXP, SEXP suffstatSEXP, SEXP score_freqSEXP, SEXP diffSEXP, SEXP NPSEXP, SEXP WSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type esf_par0(esf_par0SEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(immer_cml_agrad_helper(esf_par0, parm_index, splitvec_len, suffstat, score_freq, diff, NP, W));
    return rcpp_result_gen;
END_RCPP
}
// immer_pnorm
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_immer_immer_cml_agrad_helper", (DL_FUNC) &_immer_immer_cml_agrad_helper, 8},
