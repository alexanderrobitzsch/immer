...
immer_jml_update_item_derivatives <- function(theta, score_items, N, K, I, dat_resp, b, A_, xsi, max_incr, b_fixed) {
    .Call('_immer_immer_jml_update_item_derivatives', PACKAGE = 'immer', theta, score_items, N, K, I, dat_resp, b, A_, xsi, max_incr, b_fixed)
}

immer_jml_update_theta_derivatives <- function(theta, score_pers, N, K, I, b, max_incr, dat_resp) {
    .Call('_immer_immer_jml_update_theta_derivatives', PACKAGE = 'immer', theta, score_pers, N, K, I, b, max_incr, dat_resp)
}
